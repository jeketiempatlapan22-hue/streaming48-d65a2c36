...
-- Add external_show_id column to shows table
ALTER TABLE public.shows ADD COLUMN IF NOT EXISTS external_show_id text DEFAULT NULL;

-- Update get_public_shows to include external_show_id
