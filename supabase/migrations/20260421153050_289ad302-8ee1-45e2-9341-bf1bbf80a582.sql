...
-- Fix reseller_create_token: replace gen_random_bytes (extensions schema, not visible
-- under search_path='public') with gen_random_uuid() based code generator.
...
BEGIN
  ...
  -- Generate unique code using gen_random_uuid (always available)
  LOOP
...
-- Same fix for the WhatsApp / by_id variant
